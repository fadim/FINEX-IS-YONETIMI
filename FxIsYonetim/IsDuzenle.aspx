<%@ Page Title="" Language="C#" MasterPageFile="~/Fxls.Master" AutoEventWireup="true" CodeBehind="IsDuzenle.aspx.cs" Inherits="FxIsYonetim.IsDuzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" GroupingText="İş Düzenleme" Width="100%">
        <table class="style1">
            <tr>
                <td class="style10">
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td class="style14">
                    <asp:DropDownList ID="ddlIsTuru" runat="server" Width="125px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td class="style12">
                    <asp:TextBox ID="txtIlkGorusme" runat="server"></asp:TextBox>
                </td>
                <td class="style14" colspan="2">
                    <asp:Panel ID="Panel3" runat="server" Width="256px">
                    </asp:Panel>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSonGorusme" runat="server" Width="125px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style10">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlIlgılıPersonel" runat="server" Width="125px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td class="style5">
                    <asp:TextBox ID="txtNot" runat="server" TextMode="MultiLine" Height="36px">Enter Text</asp:TextBox>
                </td>
            ...
            <tr>
                <td class="style4" colspan="2">
                    &nbsp;</td>
                <td class="style7" colspan="2">
                    <asp:Panel ID="Panel2" runat="server"  GroupingText="İş Ekleri" Width="256px">
                        <asp:TextBox ID="txtIsEkleri" runat="server"   TextMode="MultiLine" Width="256px"></asp:TextBox>
                    </asp:Panel>
                </td>
            </tr>
            <tr>
