<%@ Page Title="" Language="C#" MasterPageFile="~/Fxls.Master" AutoEventWireup="true"
    CodeBehind="PersonelListesi.aspx.cs" Inherits="FxIsYonetim.PersonelListesi" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:Panel ID="Panel1" runat="server" GroupingText="Personel Listesi">
    
    <asp:GridView ID="grvPersonel" runat="server" Width="100%" 
        AutoGenerateColumns="False" EmptyDataText="Personel Bulunamadı" 
       >
        <Columns>
            ...
            <asp:TemplateField HeaderText="Fotoğraf">
                <ItemTemplate>
                    <asp:Image ID="imgPersonel" runat="server" ImageUrl=<%# Eval("Foto") %> 
